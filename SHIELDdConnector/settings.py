"""
Django settings for SHIELDdConnector project.
...
SECRET_KEY = '&q4&+zh-i4mse=qdc3^7p9*k$3+9huvy26%m_9lgc^-4tr=tou'
...
ROOT_URLCONF = 'SHIELDdConnector.urls'
...
WSGI_APPLICATION = 'SHIELDdConnector.wsgi.application'
